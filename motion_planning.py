...
from planning_utils import a_star, heuristic, create_grid, path_pruning
...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        # The goal position will be selected randomly.It should be confirmed that
        ...
        print('Path finding algorithm initialized')
        path, _ = a_star(grid, heuristic, grid_start, grid_goal)
        
        # TODO: prune path to minimize number of waypoints
        print('Path pruning initialized')
        path = path_pruning(path)
